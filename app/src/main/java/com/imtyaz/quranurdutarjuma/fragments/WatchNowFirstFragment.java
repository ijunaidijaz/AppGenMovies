...
import com.imtyaz.quranurdutarjuma.databinding.WatchNowFirstFragmentBinding;
...
import com.imtyaz.quranurdutarjuma.viewModels.WatchNowFirstViewModel;
...
//                Toast.makeText(this, "UnSuccessful" + response.message, Toast.LENGTH_SHORT).show();
    ...
    public void openWatchNowFirstFragment(List<Songs_list> songs_list) {
        ...
        bundle.putSerializable("applicationSettings", applicationSettings);
        ((MainActivity) getActivity()).fragmentTrx(WatchNowFirstFragment.newInstance(), bundle, "Second");
